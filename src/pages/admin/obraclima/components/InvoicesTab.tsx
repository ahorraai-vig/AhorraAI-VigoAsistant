...
import { FileText, FileUp, Receipt, Send } from 'lucide-react';
         ...
         <div className="bg-slate-800 p-4 sticky top-0 flex flex-wrap justify-between items-center print:hidden shadow-lg z-50 gap-3">
           ...
           <div className="flex flex-wrap gap-2.5">
             ...
             <button
               ...
               title="Enviar factura con PDF oficial adjunto de forma nativa"
             >
          ...
          <tbody className="divide-y divide-slate-100">
            {invoices.map((i: any) => (
              <tr key={i.id} className="hover:bg-slate-50 transition-colors">
                ...
                <td className="p-4 font-medium text-slate-800">{i.client?.name || i.customer?.name || 'Cliente'}</td>
                ...
                <td className="p-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button
                      ...
                      title="Enviar Factura con PDF adjunto de forma nativa"
                    >
                      <Send size={13} />
                      <span>Enviar Factura</span>
                    </button>
                    <button
                      onClick={() => { setSelected(i); setMode('view'); }}
